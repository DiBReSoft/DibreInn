<%-- 
    Document   : estadias-agendadas
    Created on : 03/06/2015, 12:57:53
    Author     : Thiago
--%>
...
<t:defaultTemplate>
  ...
  <jsp:attribute name="paginaTitulo">
    Relatório de Estadias Agendadas
  </jsp:attribute>
  ...
  <jsp:body>
    ...
    <h1 class="page-title">
      Relatórios de Estadias Agendadas
    </h1>
